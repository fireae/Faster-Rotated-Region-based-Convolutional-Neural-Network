...
from modules.anchor_target_creator import AnchorTargetCreator
from modules.proposal_target_creator import ProposalTargetCreator
    ...
    * :obj:`roi_cls_loss`: The classification loss for the head module.
    ...
    def __call__(self, imgs, bboxes, labels, scale):
        ...
        * :math:`R` is the number of bounding boxes per image.
        ...
        roi_cls_loc = roi_cls_loc.reshape(n_sample, -1, 5)
