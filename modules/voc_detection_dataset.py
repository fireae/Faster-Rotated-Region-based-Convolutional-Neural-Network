    ...
    def get_example(self, i):
        ...
        for obj in anno.findall('object'):
            ...
            if points[2] - points[0] >= points[3] - points[1]:
                ...
                theta = math.pi/2
            bbox.append(
                [(points[2] + points[0])/2, (points[3] + points[1])/2, max(points[2] - points[0], points[3] - points[1]),
                 min(points[2] - points[0], points[3] - points[1]), theta])
