...
from numpy import floor, cos, sin, pi
from modules.faster_rcnn import FasterRCNN
from modules.region_proposal_network import RegionProposalNetwork
from modules import download
# from modules.roi_pooling_2d import roi_pooling_2d
from modules.original_roi_pooling_2d import roi_pooling_2d
...
class VGG16RoIHead(chainer.Chain):
    ...
    def __init__(self, n_class, roi_size, spatial_scale,
        ...
        super(VGG16RoIHead, self).__init__(
            ...
            cls_loc=L.Linear(4096, n_class * 5, initialW=loc_initialW),
